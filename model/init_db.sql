...
-- ALTER TABLE `days` ADD CONSTRAINT `days_fk0` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`);
...
INSERT INTO days (date, user_id)
    VALUES ("27.10.2022", 1), ("28.10.2022", 2), ("29.10.2022", 2), ("30.10.2022", 2), ("31.10.2022", 2), ("31.10.2022", 2);

INSERT INTO tasks (title, description, completed, day_id, user_id)
    VALUES ("Learn React", "Go through slides and try to write simple application", true, 1, 1), ("Do challenge on Codewars", "Solve Kata", false, 1, 1), 
